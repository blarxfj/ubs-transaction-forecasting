...
def main():
    ap=argparse.ArgumentParser();ap.add_argument('--data',required=True);ap.add_argument('--cache',required=True);ap.add_argument('--output',required=True);ap.add_argument('--mode',choices=['wide','candidate','ranker'],default='candidate');ap.add_argument('--iterations',type=int,default=800);ap.add_argument('--depth',type=int,default=5);ap.add_argument('--lr',type=float,default=.04);ap.add_argument('--seeds',default='0');ap.add_argument('--weights',action='store_true');a=ap.parse_args()
    ...
    wide,candidates=matrices(z);x=wide if a.mode=='wide' else candidates
