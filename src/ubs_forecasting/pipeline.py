...
FEATURE_SPECS = {
    ...
    "trainT1": FeatureSpec("train", "redraw", {**TEST_LEVEL, "seed": 1}),
    "trainT2": FeatureSpec("train", "redraw", {**TEST_LEVEL, "seed": 2}),
    "trainV3": FeatureSpec("train", "redraw", {**VALID_LEVEL, "seed": 3}),
    "trainV4": FeatureSpec("train", "redraw", {**VALID_LEVEL, "seed": 4}),
